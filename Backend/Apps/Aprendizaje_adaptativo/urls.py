...
from .views import (
    TestPerfilView, 
    PerfilAprendizajeView, 
    CursoTemaView, 
    TemaDificultadView,
    GenerarPlanificacionView, 
    PlanificacionesView, 
    SesionesEstudioView,
    GuardarPlanInteligenteView,
    GenerarPlanInteligenteView
)
...
urlpatterns = [
    ...
    path("guardar_plan_inteligente/", GuardarPlanInteligenteView.as_view(), name="guardar_plan_inteligente"),
    path("generar_plan_inteligente/", GenerarPlanInteligenteView.as_view()),
